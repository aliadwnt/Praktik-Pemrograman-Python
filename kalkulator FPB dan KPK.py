...
def main():
    while True:
        ...
        if pilihan == 1: #case1 untuk mencari FPB
            try:
                print(" ")
                a = int(input("Masukkan bilangan Pertama : ")) #inputan untuk bil.A
                b = int(input("Masukkan bilangan Kedua: ")) #inputan untuk bil.B
            except ValueError:
                print("Input data tidak valid, silahkan input data dengan benar")
                continue
            fpb = hitung_fpb(a, b)
